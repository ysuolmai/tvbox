...
const http = function(url, options = {}) {
    if (options.method === "POST" && options.data) {
        ...
        options.headers = Object.assign({
            'Authorization': 'alist-09ceb38a-f143-47f7-b255-c3eec819cd7btcq0cvAIR1JUSoA4xPrHZo1Shr7NBC0V35FxPuydlyfJQ0eXAXvXqRaKSE1a6TOE'
        }, options.headers);
    }
...
function homeVod(params) {
	...
	let display_path = '';	
	    ...
	    poster = "http://172.28.1.7:5678/image/" + uri_parts[1];
                have_pic = 1;
         }
        if (parts.length >= 4) {                                   
                douban_rate = parts[3] ;
